...
+ `bubbleSort(A[], lo, hi)`;
  ...
  > 
  > <img sr="https://media.giphy.com/media/eoOiXNwSx0D4e88ZQP/giphy.gif" width="700px" />
...
+ `mergeSort(A[], lo, hi)`;
  ...
  > [算法演示](https://visualgo.net/en/sorting?slide=1}
  > 
  > <img sr="https://media.giphy.com/media/jA5VMeC1SYgIHt3nXw/giphy.gif" width="700px" />
